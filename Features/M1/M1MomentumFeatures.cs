...
namespace ForexFeatureGenerator.Features.M1
{
    public class M1MomentumFeatures : BaseFeatureCalculator
    {
        ...
        public override void Calculate(FeatureVector output, IReadOnlyList<OhlcBar> bars, int currentIndex)
        {
            ...
            output.AddFeature("m1_ema_5", ema5);
            output.AddFeature("m1_ema_8", ema8);
            output.AddFeature("m1_ema_ratio", SafeDiv(ema5, ema8, 1.0));
            ...
            if (currentIndex >= 5)
            {
                ...
                output.AddFeature("m1_roc_5", roc5);

                // Acceleration (change in ROC)
                var acceleration = roc5 - _prevRoc5;
                output.AddFeature("m1_price_acceleration", acceleration);
                _prevRoc5 = roc5;
            }
            ...
            if (currentIndex >= 10)
            {
                ...
                output.AddFeature("m1_roc_10", roc10);
            }
        }
